...
{   
    /// <summary>
    /// Propiedad privada de turno
    /// </summary>
    private int turno;

    /// <summary>
    /// Propiedad publica de tablero
    /// </summary>
    public int[,] tablero;

    /// <summary>
    /// Agrega una propiedad pública para acceder al tablero
    /// </summary>
    public int[,] Tablero
    {
        get { return tablero; }
    ...
    /// <summary>
    /// Agrega una propiedad pública para acceder a turno
    /// </summary>
    public int Turno
    {
        get { return turno; }
